  ...
  useEffect(() => {
    ...
    const enterHandler = (e) => {
      ...
      const updateCorners = (mouseX, mouseY) => {
        ...
        // Snap cursor to target center (magnetic effect)
        gsap.to(cursorRef.current, {
          x: targetCenterX,
          y: targetCenterY,
          duration: 0.3,
        ...
        // Position corners relative to cursor (which is now at target center)
        ...
        let trOffset = {
          x: halfWidth + borderWidth - cornerSize,
          y: -halfHeight - borderWidth,
        };
        let brOffset = {
          x: halfWidth + borderWidth - cornerSize,
          y: halfHeight + borderWidth - cornerSize,
        };
        let blOffset = {
          x: -halfWidth - borderWidth,
          y: halfHeight + borderWidth - cornerSize,
